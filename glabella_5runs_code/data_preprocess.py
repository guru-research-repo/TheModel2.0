        ...
        for split in splits:
            ...
            for label_dir in input_split.iterdir():
                ...
                for img_file in label_dir.iterdir():
                    ...
                    #     cv2.circle(foveated_bgr, center, 4, (0, 0, 255), thickness=-1)  # red dot
                    ...
                    # visualize_pipeline(samples)
                        ...
                        for folder_name, inversion in targets:
                            center = get_glabella_or_center(tensor_to_bgr(tensor)) # width (x), height (y)
                            rotated = rotate(tensor, inversion=inversion, center=center)
                            foveated = foveation(rotated, center=center)
                            C, H, W = foveated.shape
                            logpolar = logpolar_manual(foveated, (H, W), (H, W), center=(center[1], center[0]))
